        ...
        <div class="col-sm-12">
            <div class="card rounded shadow">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route("edit.guru" , ["id" => $guru->id]) }}" method="post">
                        @csrf
                        @method("PUT")
                        <div class="form-group">
                            <label for="name">Name</label>
                            <input type="text" name="name" id="name" class="form-control" value="{{ $guru->name }}" readonly>
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="username" id="username" class="form-control" value="{{ $guru->username }}" readonly>
                            @error('username')
                                <span class="text-danger">
                                    <strong>{{ $message }}</strong>
                                </span>
